                ...
                <form @submit.prevent="onSubmit" @submit="updateBook()">
                    ...
                    <div class="row">
                        <div class="col-sm-12 mt-2">
                            <button class="btn btn-dark col-12 mt-1 ml-2" type="submit">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
...
export default {
    ...
    methods: {
        async getBook(id) {
            ...
            if (response) {
                this.form.title = response.detail.title;
                this.form.author = response.detail.author;
                this.form.genre = response.detail.genre;
                this.form.isbn = response.detail.isbn;
                this.form.image = response.detail.image;
                this.form.published_on = response.detail.published_on;
                this.form.publisher = response.detail.publisher;
                this.form.description = response.detail.description;
